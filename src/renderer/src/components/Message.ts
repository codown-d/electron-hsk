import { IResponseError, WebResponse } from '@renderer/definitions'
import { translations } from '@renderer/translations'
import { message } from 'antd'
import { throttle } from 'lodash'

export declare type MessageTypeOptions = 'info' | 'success' | 'warning' | 'error' | 'loading'
...
let throttleMessage = throttle(
  (msg: string, errorCode: string | number) => {
    msg &&
      message.open({
